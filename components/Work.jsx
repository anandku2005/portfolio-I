...
const Work = ({isDarkMode}) => {
  return (
    <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 1}} id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <motion.p initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.5, delay: 0.7}} className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my academic portfolio. A collection of my academic work, certifications, and skill-based learning as a Bachelor of Commerce undergraduate.</motion.p>
